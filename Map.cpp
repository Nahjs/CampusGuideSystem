...
void Map::InitPoint(){
    ...
    point[11] = QPoint(197,200);//天佑会堂              42
    ...
    point[37] = QPoint(335,220);//思东明湖路口
...
void Map::doProcessDataToMap(int num){
    selectedPlaceNum = num;
}

void Map::doProcessSaveWalkRouteToMap(int a,int b,int c,int d,int e,int f,int g,int h,int i,int j,int k,int l,int m,int n,int o,int p,int q,int r,int s,int t){
    walkRoute[0] = a;
    walkRoute[1] = b;
    walkRoute[2] = c;
    walkRoute[3] = d;
...
void Map::doProcessReturnToInquiry(bool){
