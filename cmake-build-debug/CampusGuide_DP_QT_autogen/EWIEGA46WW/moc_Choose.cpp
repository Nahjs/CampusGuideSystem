...
Q_CONSTINIT static const qt_meta_stringdata_CLASSChooseENDCLASS_t qt_meta_stringdata_CLASSChooseENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 6),  // "AddMap"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 15),  // "SignalDataToMap"
        QT_MOC_LITERAL(31, 7),  // "int[20]"
        QT_MOC_LITERAL(39, 9),  // "walkRoute"
        QT_MOC_LITERAL(49, 18),  // "signalDataToInform"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChooseENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       7,   20,   87,    2, 0x06,    6 /* Public */,
       8,    0,  128,    2, 0x06,   27 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       9,    1,  129,    2, 0x08,   28 /* Private */,
      10,    1,  132,    2, 0x08,   30 /* Private */,
      11,    1,  135,    2, 0x08,   32 /* Private */,
      12,    1,  138,    2, 0x08,   34 /* Private */,
      13,    1,  141,    2, 0x08,   36 /* Private */,
      14,    0,  144,    2, 0x08,   38 /* Private */,
...
Q_CONSTINIT const QMetaObject Choose::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChooseENDCLASS_t,
        ...
        // method 'signalDataToInform'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'SignalWalkRouteToInform'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'doProcessAddMap'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'doProcessClean'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<bool, std::false_type>,
        // method 'doProcessInputFile'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Choose::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->AddMap(); break;
        case 1: _t->SignalDataToMap((*reinterpret_cast< std::add_pointer_t<int[20]>>(_a[1]))); break;
        case 2: _t->signalDataToInform((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        case 10: _t->doProcessInputFile(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Choose::AddMap; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Choose::*)(int [20]);
            if (_t _q_method = &Choose::SignalDataToMap; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Choose::signalDataToInform; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Choose::*)(int , int , int , int , int , int , int , int , int , int , int , int , int , int , int , int , int , int , int , int );
            if (_t _q_method = &Choose::SignalWalkRouteToInform; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Choose::*)();
            if (_t _q_method = &Choose::inputFile; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void Choose::SignalDataToMap(int _t1[20])
{
...
// SIGNAL 2
void Choose::signalDataToInform(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void Choose::SignalWalkRouteToInform(int _t1, int _t2, int _t3, int _t4, int _t5, int _t6, int _t7, int _t8, int _t9, int _t10, int _t11, int _t12, int _t13, int _t14, int _t15, int _t16, int _t17, int _t18, int _t19, int _t20)
{
