...
public:
    ...
    void setupUi(QWidget *bjtuMap)
    {
        ...
        bjtuMap->resize(637, 545);
        groupBox = new QGroupBox(bjtuMap);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(80, 600, 521, 131));
        ...
        pushButton_return->setGeometry(QRect(570, 460, 41, 41));
        QFont font2;
        font2.setFamilies({QString::fromUtf8("\351\273\221\344\275\223")});
        font2.setPointSize(12);
        pushButton_return->setFont(font2);
        QIcon icon;
        icon.addFile(QString::fromUtf8("C:/Users/lenovo/Desktop/res/\345\210\267\346\226\260.png"), QSize(), QIcon::Normal, QIcon::Off);
