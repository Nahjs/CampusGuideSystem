...
void bjutmap::Init(){
    ...
    QPalette p1;
    p1.setColor(QPalette::Window, QColor(70,70,70));
...
void bjutmap::InitPic(){
    pic[0] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location1.png)");
    pic[1] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location2.png)");
    pic[2] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location3.png)");
    pic[3] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location4.png)");
    pic[4] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location5.png)");
    pic[5] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location6.png)");
    pic[6] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location7.png)");
    pic[7] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location8.png)");
    pic[8] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location9.png)");
    pic[9] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location10.png)");
    pic[10] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location11.png)");
    pic[11] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location12.png)");
    pic[12] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location13.png)");
    pic[13] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location14.png)");
    pic[14] = QPixmap(R"(..\CampusGuide_DP_QT\\Resource\location15.png)");
...
void bjutmap::doProcessGrabScreen(bool){
    ...
    QPixmap pixmap = screen->grabWindow(0);
    pixmap.save(R"(D:\Junior1\DS_Qt\CampusGuide_DP_QT\Email\result.jpg)");
}
